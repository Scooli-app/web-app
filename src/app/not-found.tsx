...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen bg-[#EEF0FF] flex flex-col items-center justify-center p-6">
      {/* Logo */}
      <div className="mb-8">
        <Image
          src="/scooli.svg"
      ...
      <Card className="w-full max-w-md p-8 text-center">
        ...
        <div className="space-y-3">
          <Button
            asChild
            className="w-full bg-[#6753FF] hover:bg-[#4E3BC0] text-white"
          >
          ...
          <Button
            ...
            className="w-full border-[#C7C9D9] text-[#0B0D17] bg-white hover:bg-[#EEF0FF]"
          >
