const AppleIcon = ({
  ...
  return (
    <svg
      ...
      viewBox={viewBox}
      fill={color}
      className={`icon icon-tabler icons-tabler-filled icon-tabler-brand-apple dark:invert ${className}`}
    >
      <path stroke="none" d="M0 0h24v24H0z" fill={background} opacity={opacity} style={{ transform: transforms.join(" "), filter: shadow ? `drop-shadow(0 0 ${shadow}px ${color})` : undefined }} />
